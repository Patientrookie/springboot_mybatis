 ...
 * @Description TODO
 * @Author xiaqi
 * @Date 18/06/2020 9:27
 * @Version 1.0
 **/
public class MPGenerator {

    /** 作者 */
    private static String AUTHOR = "shawn";
    /** 生成的实体类忽略表前缀: 不需要则置空 */
    ...
    *//** Controller.java输出模块路径 *//*
    ...
    private static String url = "jdbc:mysql://127.0.0.1:3306/mybatis_demo?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8";
            ...
            public void initMap() {
                ...
                .setFileCreate(new IFileCreate() {
                    ...
                    public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
                        ...
                        if (isExists(filePath) && (!filePath.endsWith("Mapper.xml") && !filePath.endsWith("Entity.java") && !filePath.endsWith("Mapper.java"))) {
                            return false;
                        }
